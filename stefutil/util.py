...
__all__ = [
    ...
    'get', 'set_', 'it_keys',  # functional, deep dictionary syntactic sugar
    'StefConfig', 'StefUtil',  # Project & project file structure related
    'get_hostname', 'stem',  # os-related
    'vars_',  # enhanced-built-in functions
    'is_float', 'get_substr_indices',  # primitive & numpy manipulation
    # data structure manipulation
    'list_is_same_elms', 'chain_its', 'join_it', 'group_n', 'list_split', 'lst2uniq_ids', 'compress', 'np_index',
    ...
    'profile_runtime', 'RecurseLimit',  # function-level manipulation
