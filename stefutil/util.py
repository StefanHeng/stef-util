...
__all__ = [
    ...
    'get_hostname',  # os-related
    'chain_its', 'join_it', 'group_n', 'lst2uniq_ids',  # iterable manipulation
    'conc_map', 'batched_conc_map',  # concurrency
    'get_substr_indices',  # str manipulation
    'fmt_dt',   # prettier & prettier logging
    'now', 'profile_runtime',  # timing
]
...
def log_dict(d: Dict = None, with_color=True, **kwargs) -> str:
    """
    Syntactic sugar for prettier dict with coloring for console output, no intendation
    """
    if d is None:
        d = kwargs
